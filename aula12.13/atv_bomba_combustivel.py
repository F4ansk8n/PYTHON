class BombaCombustivel:
    ...
    def set_tipo_combustivel(self):
        print('!!!!SEJA BEM VINDO AO POSTO VALLEY!!!!')

        while True:
            self.tipo_combustivel = input('Qual o tipo de combustível que o(a) senhor(a) deseja? Digite [A] para Álcool ou [G] para Gasolina: ').lower()
    ...
    def abastecer_dinheiro(self):
        dinheiro = float(input(f'Informe o valor que você deseja abastecer em R$: '))
